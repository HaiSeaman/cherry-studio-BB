...
describe('Unified Provider Types', () => {
  ...
  describe('AppProviderId - All Providers', () => {
    ...
    it('should include all project extension names', () => {
      ...
      type Check3 = 'perplexity' extends AppProviderId ? true : false
      type Check4 = 'mistral' extends AppProviderId ? true : false
      type Check5 = 'huggingface' extends AppProviderId ? true : false
      type Check6 = 'gateway' extends AppProviderId ? true : false
      type Check7 = 'cerebras' extends AppProviderId ? true : false
    ...
    it('should include all aliases (core + project)', () => {
      ...
      type Check5 = 'hf' extends AppProviderId ? true : false
      type Check6 = 'hugging-face' extends AppProviderId ? true : false
      type Check7 = 'ai-gateway' extends AppProviderId ? true : false

          ...
          <SearchBarContainer $position={positionMode}>
            <InputWrapper>
              ...
              <ToolBar>
                ...
                <Tooltip title={'全字匹配'} mouseEnterDelay={0.8} placement="bottom">

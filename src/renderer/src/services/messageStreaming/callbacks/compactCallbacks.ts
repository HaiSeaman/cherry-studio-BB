...
/**
 * Minimal structural type for raw stream parts emitted by Claude Code style SDKs.
 * Previously imported from the removed `@shared/agents` package.
 */
type ClaudeCodeRawValue = {
  type: string
  session_id?: string
  [key: string]: unknown
}

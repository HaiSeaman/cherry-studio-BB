...
const ThinkingButton: FC<Props> = ({
  ...
  const onThinkingChange = useCallback(
    ...
    [isControlled, onReasoningEffortChange, updateAssistantSettings, assistant.enableWebSearch, model]
  )
  ...
  }, [currentReasoningEffort, openQuickPanel, quickPanel, isFixedReasoning])

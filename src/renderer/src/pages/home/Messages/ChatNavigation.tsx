    ...
    <>
      <NavigationContainer
        ...
        <ButtonGroup $isVisible={isVisible}>
          ...
          <Divider />
          <Tooltip title={'回到底部'} placement="left" mouseEnterDelay={0.5}>
            <NavigationButton
              type="text"
          ...
          <Divider />
          <Tooltip title={'聊天历史'} placement="left" mouseEnterDelay={0.5}>
            <NavigationButton
              type="text"

...
const PopupContainer: React.FC<Props> = ({ title, apiKeys, resolve }) => {
    ...
    return (
      <Flex vertical gap={10}>
        <Flex align="center" justify="space-between" style={{ width: '100%' }}>
          <Typography.Text strong>{'使用密钥'}:</Typography.Text>
          <Segmented
            value={keyCheckMode}
        ...
        <Flex align="center" justify="space-between" style={{ width: '100%' }}>
          <Typography.Text strong>{'并发检测'}:</Typography.Text>
          <Segmented
        ...
        <Flex align="center" justify="space-between" style={{ width: '100%' }}>
          <Typography.Text strong>{'超时'}:</Typography.Text>
          <InputNumber
  ...
  }, [isConcurrent, keyCheckMode, timeoutSeconds])
  ...
  return (
    <Modal
      ...
      <Alert
        description={'健康检查需要发送请求，请谨慎使用。按次收费的模型可能产生更多费用，请自行承担。'}
        type="warning"
        showIcon

      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          <SettingRowTitle style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <span>{'启用快捷助手'}</span>
            <Tooltip title={'右键点击托盘图标或使用快捷键启动'} placement="right">
        ...
        {enableQuickAssistant && (
          <>
            <SettingDivider />
            <SettingRow>
              <SettingRowTitle>{'点击托盘图标启动'}</SettingRowTitle>
        ...
        {enableQuickAssistant && (
          <>
            <SettingDivider />
            <SettingRow>
              <SettingRowTitle>{'启动时读取剪贴板'}</SettingRowTitle>
        ...
        <SettingGroup theme={theme}>
          <HStack alignItems="center" justifyContent="space-between">
            <HStack alignItems="center" gap={10}>
              {'快捷助手模型'}
              <Tooltip title={'使用助手：会同时使用助手的系统提示词和模型参数'} arrow>
                <InfoCircleOutlined style={{ cursor: 'pointer' }} />
              </Tooltip>
              <Spacer />
            </HStack>
                    ...
                    options={[
                      {
                        ...
                        label: (
                          <AssistantItem>
                            ...
                            <Spacer />
                            <DefaultTag isCurrent={true}>{'默认'}</DefaultTag>
                          </AssistantItem>
                        )
                      },
                      ...assistants

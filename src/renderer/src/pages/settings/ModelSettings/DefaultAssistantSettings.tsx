  ...
  return (
    <SettingContainer
      ...
      <HStack gap={8} alignItems="center" mt={10}>
        ...
        <Input placeholder={'助手' + '名称'} value={name} onChange={handleNameChange} style={{ flex: 1 }} />
      </HStack>
      <SettingSubtitle style={{ marginTop: 0 }}>{'提示词'}</SettingSubtitle>
      <TextArea
        rows={4}
        placeholder={'助手' + '提示词'}
      ...
      <SettingSubtitle
        ...
        {'模型参数'}
        <Tooltip title={'重置'} mouseLeaveDelay={0}>

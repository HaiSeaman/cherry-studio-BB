...
const ActionTranslate: FC<Props> = ({ action, scrollToBottom }) => {
  ...
  const settingsMenuItems = useMemo(
    () => [
      {
        ...
        label: (
          <SettingsMenuItem>
            <SettingsLabel>{'首选目标'}</SettingsLabel>
            <LanguageSelect
      ...
      },
      {
        ...
        label: (
          <SettingsMenuItem>
            <SettingsLabel>{'备用语言'}</SettingsLabel>
            <LanguageSelect
    ...
    [targetLanguage, alterLanguage, isStreaming, getLanguageByLangcode, handleChangeLanguage]
  )
      ...
      <Container>
        <MenuContainer>
          <LeftGroup>
            ...
            <DetectedLanguageTag>
              {isPreparing ? (
                ...
                <>
                  ...
                  <span>{detectedLanguage?.label() || '检测到'}</span>
                </>
              )}
            </DetectedLanguageTag>
            ...
            <Tooltip
              title={'智能翻译：内容将优先翻译为目标语言；内容已是目标语言的，将翻译为备选语言'}
              placement="bottom">
              <HelpIcon size={14} />
            </Tooltip>
          </LeftGroup>
        ...
        {showOriginal && (
          <OriginalContent>
            ...
            <OriginalContentCopyWrapper>
              <CopyButton textToCopy={action.selectedText!} tooltip={'复制原文'} size={12} />
            </OriginalContentCopyWrapper>
          </OriginalContent>
        )}
        <Result>

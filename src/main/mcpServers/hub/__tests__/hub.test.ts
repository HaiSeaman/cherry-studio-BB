...
vi.mock('@main/services/ConfigManager', () => ({
  ConfigKeys: { HubExecEnabled: 'hubExecEnabled' },
  configManager: {
    // The exec tool is disabled by default for security; integration tests
    // explicitly enable it.
    get: vi.fn((key: string) => (key === 'hubExecEnabled' ? true : undefined))
  }
}))

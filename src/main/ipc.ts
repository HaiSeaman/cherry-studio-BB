...
export async function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.File_SaveFileAs, fileManager.saveFileAs.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_SaveFileToDirectory, fileManager.saveFileToDirectory.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.Fs_ScanDir, FileService.scanDir.bind(FileService))
